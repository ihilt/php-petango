...
/**
 * This class stands for lostSearch StructType
 * @subpackage Structs
 */
class LostSearch extends AbstractStructBase
{
    /**
     * The speciesID
    ...
    public $orderBy;
    /**
     * Constructor method for lostSearch
     * @uses LostSearch::setSpeciesID()
     * @uses LostSearch::setSex()
     * @uses LostSearch::setAgeGroup()
     * @uses LostSearch::setAuthkey()
     * @uses LostSearch::setOrderBy()
     * @param int $speciesID
     * @param string $sex
