...
/**
 * This class stands for AdoptableSearch StructType
 * @subpackage Structs
 */
class AdoptableSearch extends AbstractStructBase
{
    /**
     * The authkey
    ...
    public $stageID;
    /**
     * Constructor method for AdoptableSearch
     * @uses AdoptableSearch::setAuthkey()
     * @uses AdoptableSearch::setSpeciesID()
     * @uses AdoptableSearch::setSex()
     * @uses AdoptableSearch::setAgeGroup()
     * @uses AdoptableSearch::setLocation()
     * @uses AdoptableSearch::setSite()
     * @uses AdoptableSearch::setOnHold()
     * @uses AdoptableSearch::setOrderBy()
     * @uses AdoptableSearch::setPrimaryBreed()
     * @uses AdoptableSearch::setSecondaryBreed()
     * @uses AdoptableSearch::setSpecialNeeds()
     * @uses AdoptableSearch::setNoDogs()
     * @uses AdoptableSearch::setNoCats()
     * @uses AdoptableSearch::setNoKids()
     * @uses AdoptableSearch::setStageID()
     ...
     */
    public function __construct($authkey = null, $speciesID = null, $sex = null, $ageGroup = null, $location = null, $site = null, $onHold = null, $orderBy = null, $primaryBreed = null, $secondaryBreed = null, $specialNeeds = null, $noDogs = null, $noCats = null, $noKids = null, $stageID = null)
    {
        $this
            ->setAuthkey($authkey)
     ...
     * Set authkey value
     * @param string $authkey
     * @return \StructType\AdoptableSearch
     */
