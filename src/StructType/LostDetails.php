...
/**
 * This class stands for lostDetails StructType
 * @subpackage Structs
 */
class LostDetails extends AbstractStructBase
{
    /**
     * The animalID
    ...
    public $authkey;
    /**
     * Constructor method for lostDetails
     * @uses LostDetails::setAnimalID()
     * @uses LostDetails::setAuthkey()
     * @param int $animalID
