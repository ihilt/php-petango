...
/**
 * This class stands for foundSearchForCompanyGroup StructType
 * @subpackage Structs
 */
class FoundSearchForCompanyGroup extends AbstractStructBase
{
    /**
     * The speciesID
    ...
    public $orderBy;
    /**
     * Constructor method for foundSearchForCompanyGroup
     * @uses FoundSearchForCompanyGroup::setSpeciesID()
     * @uses FoundSearchForCompanyGroup::setSearchOption()
     * @uses FoundSearchForCompanyGroup::setSex()
     * @uses FoundSearchForCompanyGroup::setAgeGroup()
     * @uses FoundSearchForCompanyGroup::setAuthkey()
     * @uses FoundSearchForCompanyGroup::setOrderBy()
     * @param int $speciesID
     ...
     * Set speciesID value
     * @param int $speciesID
     * @return \StructType\FoundSearchForCompanyGroup
     */
