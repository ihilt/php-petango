...
/**
 * This class stands for foundDetailsForCompanyGroup StructType
 * @subpackage Structs
 */
class FoundDetailsForCompanyGroup extends AbstractStructBase
{
    /**
     * The animalID
    ...
    public $authkey;
    /**
     * Constructor method for foundDetailsForCompanyGroup
     * @uses FoundDetailsForCompanyGroup::setAnimalID()
     * @uses FoundDetailsForCompanyGroup::setAuthkey()
     * @param int $animalID
     ...
     * Set animalID value
     * @param int $animalID
     * @return \StructType\FoundDetailsForCompanyGroup
     */
